    ...
    <section className="py-20 gradient-hero">
      <div className="container mx-auto px-4 text-center">
        ...
        <div className="flex justify-center gap-4 max-w-lg mx-auto flex-wrap">
          ...
          <a href="https://x.com/MJMKforPEOPLE" target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 bg-foreground text-background font-bold text-lg px-8 py-4 rounded-xl hover:scale-105 transition-transform shadow-strong">
            <Twitter size={28} /> Twitter / X
          </a>
        </div>
      </div>
    </section>
